...
const char *WINDOWTITLE = "Shader -- Daksh Viradiya";
...
bool KeytimePatternOn = false;
bool TimePatternOn = false;
int		SphereList;
...
Display( )
{
	...
	if (KeytimePatternOn) {
		 Usc = USc.GetValue(nowTime);
		 Utc = UTc.GetValue(nowTime);
	}

	if (TimePatternOn) {
		rs = 0.5 + 0.25 * sin(2 * M_PI * nowTime/2);
		rt = 0.25 - 0.15 * cos(2 * M_PI * nowTime/2);
	}
...
InitGraphics( )
{
	...
	USc.Init();
	USc.AddTimeValue(0.0, 0.5);
	USc.AddTimeValue(2.0, 0.6);
	USc.AddTimeValue(4.0, 0.7);
	USc.AddTimeValue(6.0, 0.6);
	USc.AddTimeValue(8.0, 0.7);
	USc.AddTimeValue(10.0, 0.5);

	UTc.Init();
	UTc.AddTimeValue(0.0, 0.5);
	UTc.AddTimeValue(2.0, 0.7);
	UTc.AddTimeValue(4.0, 0.6);
	UTc.AddTimeValue(6.0, 0.7);
	UTc.AddTimeValue(8.0, 0.6);
	UTc.AddTimeValue(10.0, 0.5);
