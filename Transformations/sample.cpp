...
//float Time;
#define MS_IN_THE_ANIMATION_CYCLE	10000 * 2
// function prototypes:
...
Display( )
{
	...
	// draw the Circle object by calling up its display list:
	...
	float rockAngle = 35 * Time;
	/*glPushMatrix();
	glRotatef(angle, 0.0,1.0,0.0);
	glRotatef(-10 * sin(rockAngle), 0.0, 0.0, -0.55);
	glRotatef(10 * sin(rockAngle), 0.0, 0.0, 0.55);
	glTranslatef(0.0, 0.55 * cos(rockAngle), 0.0);
	...
	float angle1 = angle;
	float rockAngle1 = rockAngle;

	float angle2 = angle + 90;  // 90-degree phase difference
	float rockAngle2 = rockAngle - 0.50;  // Another phase difference

	float angle3 = angle + 180;  // 180-degree phase difference
	float rockAngle3 = rockAngle + 0.75;  // Another phase difference

	float angle4 = angle + 270;  // 270-degree phase difference
	float rockAngle4 = rockAngle - 1.25;  // Another phase difference

	// 1st Horse
	glPushMatrix();
	glRotatef(angle1, 0.0, 1.0, 0.0);
	glRotatef(-10 * sin(rockAngle1), 0.0, 0.0, -0.55);
	glRotatef(10 * sin(rockAngle1), 0.0, 0.0, 0.55);
	glTranslatef(0.0, 0.55 * cos(rockAngle1), 0.0);
	...
	glRotatef(-10 * sin(rockAngle2), 0.0, 0.0, -0.55);
	glRotatef(10 * sin(rockAngle2), 0.0, 0.0, 0.55);
	glTranslatef(0.0, 0.55 * cos(rockAngle2), 0.0);
	glRotatef(270, 0.0, 1.0, 0.0);
	glTranslatef(-2.0, 0.0, 0.0);
	glRotatef(270, 0.0, 1.0, 0.0);
	glCallList(WireHorseList);
	...
	glRotatef(-10 * sin(rockAngle3), 0.0, 0.0, -0.55);
	glRotatef(10 * sin(rockAngle3), 0.0, 0.0, 0.55);
	glTranslatef(0.0, 0.55 * cos(rockAngle3), 0.0);
	glRotatef(270, 0.0, 1.0, 0.0);
	glTranslatef(-2.0, 0.0, 0.0);
	glRotatef(270, 0.0, 1.0, 0.0);
	glCallList(WireHorseList);
	...
	glRotatef(-10 * sin(rockAngle4), 0.0, 0.0, -0.55);
	glRotatef(10 * sin(rockAngle4), 0.0, 0.0, 0.55);
	glTranslatef(0.0, 0.55 * cos(rockAngle4), 0.0);
	glRotatef(270, 0.0, 1.0, 0.0);
	glTranslatef(-2.0, 0.0, 0.0);
	glRotatef(270, 0.0, 1.0, 0.0);
	glCallList(WireHorseList);
...
void drawCircle(float r, float cX, float cY, float cZ) {
